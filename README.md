...
- **Деньги без float-ошибок.** Все расчёты итогов — в целых минорных единицах (копейках).
...
- [x] **Бонус:** корректный расчёт суммы у.е. (в копейках, без float-ошибок)
- [x] **Бонус:** удаление статей
